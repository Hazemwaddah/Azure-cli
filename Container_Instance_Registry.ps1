...
--azure-file-volume-account-key d7rh7oWZ1KEKMFlTeIih165XzJm8ir/174KVEpYs4Pxp+G5sSg/sBk1jy5vFrDV6NzDFECpjN3ha+ASt9JxlMg== \
...
az container create -g RG-IMTD-PRD-001-DevOps \
  ...
  --azure-file-volume-account-name devopssaprd001 \
  --azure-file-volume-account-key OYyxL5xhGkyb7Ss/KyUlCW34hTFuL7IIhFVG2/OhOBnNVgeWlojakDde6RrYBLE/QDbMr1fFJ9DO+AStqLZUnA== \
...
# --azure-file-volume-account-key PvKpoQcTwifmkD/d93NxZ5Tkvsu8nw8rwIzXGNkOYfs4e84koQ3H6/Y4SlMlcdvr+NMb3kDGCDymLJlCOaVo3Q== \
...
az container create -g %ACI_RESOURCE_GROUP% -n %ACI_INSTANCE_NAME% --image owasp/zap2docker-stable --ip-address public --ports 8080 --azure-file-volume-account-name mycompanystg --azure-file-volume-account-key PvKpoQcTwifmkD/d93NxZ5Tkvsu8nw8rwIzXGNkOYfs4e84koQ3H6/Y4SlMlcdvr+NMb3kDGCDymLJlCOaVo3Q== --azure-file-volume-share-name devops-aci-prd-001 --azure-file-volume-mount-path /zap/wrk/ --command-line "zap.sh -daemon -host 0.0.0.0 -port 8080 -config api.key=abcd -config api.addrs.addr.name=.* -config api.addrs.addr.regex=true"
exit 0
