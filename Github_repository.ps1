...
ssh-keygen -t ed25519 -C "hazem.waddah@live.com"
...
curl -u Hazemwaddah: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 https://api.github.com/user
...
#
curl -X DELETE https://api.github.com/repos/Hazemwaddah/test -H "Authorization: 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" -H "Accept: application/vnd.github+json"
#
