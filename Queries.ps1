...
| extend subscription_0 = case(subscriptionId =~ '7f1f265d-dc8c-4232-af03-db9ab6f9fa63', 'UAE - Subscription', '')
...
| project-away isSubscription, subscriptionName, subscription_0| project-away resourceNameIndex, splitAffectedResourceId, hostName, isAzure| where affectedResourceName contains '/subscriptions/7f1f265d-dc8c-4232-af03-db9ab6f9fa63/resourcegroups/rg-agent-build-gws/providers/microsoft.compute/virtualmachines/cicd-agent-gwc' or affectedResourceId contains '/subscriptions/7f1f265d-dc8c-4232-af03-db9ab6f9fa63/resourcegroups/rg-agent-build-gws/providers/microsoft.compute/virtualmachines/cicd-agent-gwc'
...
securityresources
    ...
    ,'050ac097-3dda-4d24-ab6d-82568e7a50cf') 
        | where subscriptionId in ("7f1f265d-dc8c-4232-af03-db9ab6f9fa63")
...
| where id startswith "/subscriptions/7f1f265d-dc8c-4232-af03-db9ab6f9fa63/resourcegroups/rg-agent-build-gws/providers/microsoft.compute/virtualmachines/cicd-agent-gwc/patchAssessmentResults/latest/softwarePatches/"
