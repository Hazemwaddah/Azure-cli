...
az vm list-ip-addresses --resource-group rg-rpa-tst-eus --name win19-rpa-proxy-tst-eus --subscription 7f1f265d-dc8c-4232-af03-db9ab6f9fa63
# Example of setting auto-shutdown for a specific VM in your resource group.
az vm auto-shutdown --resource-group rg-rpa-tst-eus --name win19-rpa-proxy-tst-eus --time 1730 --subscription 7f1f265d-dc8c-4232-af03-db9ab6f9fa63
#Example of listing the metric values for a specific VM in your resource group.
az vm monitor metrics tail --resource-group rg-rpa-tst-eus --name win19-rpa-proxy-tst-eus --subscription 7f1f265d-dc8c-4232-af03-db9ab6f9fa63 -o table
